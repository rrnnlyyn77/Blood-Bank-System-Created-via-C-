...
void UpdateProfile() {
    ...
    cout << "                                                                         Update a Recipients Profile\n";
    cout << "\n";
    ...
    if (profileFile.is_open()) {
        ...
        cout << "\n";
        cout << "                                                          The Recipients Profile updated successfully" << endl;
        profileFile.close();
    }
    else {
...
void DeleteProfile() {
    ...
    if (profileFile.is_open()) {
        profileFile.close();
        cout << "                                                      The Recipients Profile has been deleted successfully!" << endl;
    }
    else {
        cout << "Unable to open the profile file." << endl;
    }
...
int main() {
    ...
    cout << "                                                                          Modify a Recipients Profile" << endl;
