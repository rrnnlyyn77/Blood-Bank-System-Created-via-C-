// health status form.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    healthStatsForm Healthstatsform;

    // fill-in HSF
    getNDHealthStatus (Healthstatsform);
